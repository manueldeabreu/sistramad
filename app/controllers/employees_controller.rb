class EmployeesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @employee.save
        format.html { redirect_to @employee, notice: 'Empleado fue creado exitosamente.' }
  ...
  def destroy
    @employee.destroy
    respond_to do |format|
      format.html { redirect_to employees_url, notice: 'Empleado fue eliminado exitosamente..' }
