class SendEmailTransferJob < ApplicationJob
    queue_as :default
    ...
    def send_mail()
      case @mail_template
        ...
        when 'decline_initial_requirements'  then
          NotificationMailer.decline_initial_requirements_email_transfer(@user,@transfer).deliver_later  
